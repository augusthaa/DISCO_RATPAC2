...
public:
  VertexGen_Muon(const char *arg_dbname = "MUON_SPECTRUM");
  ...
  /** Set up the spectrum array in memory - create normalised cumulative
   * magnitude for easy sampling*/
  virtual void InitialiseSpec();
